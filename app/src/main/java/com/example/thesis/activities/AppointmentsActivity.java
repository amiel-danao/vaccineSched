...
public class AppointmentsActivity extends AuthenticatedActivity {
    ...
    private void LoadAllOngoingAppointments() {
        progressDialog.show();
        String url = Urls.GET_ONGOING_APPOINTMENTS;
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, response -> {
            try {
                ...
                appointmentAdapter = new AppointmentAdapter(AppointmentsActivity.this, appointments,
